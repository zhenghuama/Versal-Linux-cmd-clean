...
public:
  ...
  simpleGraph(){
	  ...
	  connect< window<2* 16*1> >  (A        .out[0], layers[0].in[0]);
	  connect< window<2* 64*1> >  (layers[0].out[0], layers[1].in[0]);
	  connect< window<2* 32*1> >  (layers[1].out[0], layers[2].in[0]);
	  connect< window<2* 32*1> >  (layers[2].out[0], layers[3].in[0]);
	  connect< window<2*  8*1> >  (layers[3].out[0], C        .in[0]);
